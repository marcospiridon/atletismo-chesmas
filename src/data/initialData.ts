import { ClubInfo, GalleryPhoto, NewsArticle, RaceResult, TrainingSession, AthleteRegistration } from '../types';
...
export const initialResults: RaceResult[] = [
  {
    id: "res-1",
    raceName: "Campeonato Regional de Estrada 10K",
    location: "Aveiro",
    date: "2026-08-15",
    distance: "10 km",
    category: "Veteranos M40",
    athleteName: "Manuel Santos",
    bibNumber: "142",
    officialTime: "00:32:45",
    pace: "3:16 min/km",
    overallRank: 6,
    categoryRank: 1,
    podiumPosition: 1,
    medalType: "gold",
    notes: "Campeão Regional M40 e Novo Recorde Pessoal do Clube!",
    photoUrl: "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: "res-2",
    raceName: "Campeonato Regional de Estrada 10K",
    ...
    date: "2026-08-15",
    distance: "10 km",
    category: "Seniores Femininos",
    athleteName: "Sofia Ramos",
    bibNumber: "389",
    ...
    podiumPosition: 2,
    medalType: "silver",
    notes: "Medalha de Prata no escalão sénior feminino.",
    photoUrl: "https://images.unsplash.com/photo-1530549387789-4c1017266635?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: "res-3",
    raceName: "Campeonato Regional de Estrada 10K",
    ...
    date: "2026-08-15",
    distance: "10 km",
    category: "Sub-23 Masculinos",
    athleteName: "Tiago Neves",
    bibNumber: "215",
    officialTime: "00:33:18",
    pace: "3:19 min/km",
    overallRank: 9,
    categoryRank: 3,
    podiumPosition: 3,
    medalType: "bronze",
    notes: "Excelente prestação coroada com o bronze sub-23.",
    photoUrl: "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: "res-4",
    raceName: "Ultra Trail dos Miradouros",
    location: "Lousã",
    date: "2026-07-28",
    distance: "45 km (2800m D+)",
    category: "Veteranos M35",
    athleteName: "Pedro Gonçalves",
    bibNumber: "512",
    officialTime: "04:38:15",
    pace: "6:11 min/km",
    overallRank: 4,
    categoryRank: 2,
    podiumPosition: 2,
    medalType: "silver",
    notes: "2º Lugar M35 e 4º classificado na classificação geral absoluta.",
    photoUrl: "https://images.unsplash.com/photo-1502680390469-be75c86b636f?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: "res-5",
    raceName: "Trail Curto dos Miradouros",
    location: "Lousã",
    date: "2026-07-28",
    distance: "18 km (1100m D+)",
    category: "Seniores F",
    athleteName: "Maria João",
    bibNumber: "804",
    officialTime: "01:46:20",
    pace: "5:54 min/km",
    overallRank: 11,
    categoryRank: 1,
    podiumPosition: 1,
    medalType: "gold",
    notes: "Grande vitória feminina!",
    photoUrl: "https://images.unsplash.com/photo-1517649763962-0c623266ddc0?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: "res-6",
    raceName: "Meeting de Pista de Verão - 1500m",
    location: "Coimbra",
    date: "2026-07-04",
    distance: "1500 metros",
    category: "Juvenis Masculinos",
    athleteName: "Gonçalo Ribeiro",
    bibNumber: "78",
    officialTime: "04:08:40",
    pace: "2:45 min/km",
    overallRank: 2,
    categoryRank: 1,
    podiumPosition: 1,
    medalType: "gold",
    notes: "Mínimos para o Campeonato Nacional de Pista ao Ar Livre alcançados!",
    photoUrl: "https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: "res-7",
    raceName: "Meia Maratona do Douro Vinhateiro",
    location: "Peso da Régua",
    date: "2026-05-24",
    distance: "21.097 km",
    category: "Veteranos M45",
    athleteName: "Rui Costa",
    bibNumber: "1098",
    officialTime: "01:18:50",
    pace: "3:44 min/km",
    overallRank: 18,
    categoryRank: 2,
    podiumPosition: 2,
    medalType: "silver",
    notes: "Pódio conquistado numa das provas mais bonitas do mundo.",
    photoUrl: "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?auto=format&fit=crop&w=600&q=80"
  }
];
